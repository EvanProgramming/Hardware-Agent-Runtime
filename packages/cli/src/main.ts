...
function usage(): never { console.error("Usage: har project create <directory> [id] | har project show <directory> <id> | har environment | har board list | har compile <sketch> <fqbn> | har flash <sketch> <fqbn> <port> | har serial capture <port> <baud> <durationMs>"); process.exit(2); }
